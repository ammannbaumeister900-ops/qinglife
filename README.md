...
当前唯一 P0 验收版为 **acceptance-p0-20260924**，候选分支为 **release/p0-acceptance-20260924**。后台/API 验收环境和微信预览二维码都由这一版本产生，只是两个验收入口，不是两套版本。三端入口、账号说明和验收清单见 [P0 统一验收说明](docs/operations/p0-acceptance-20260924.md)。
