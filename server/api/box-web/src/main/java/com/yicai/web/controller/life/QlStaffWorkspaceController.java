...
public class QlStaffWorkspaceController {
 ...
 @PutMapping("/registrations/{id}/settlement") public AjaxResult<?> settlement(@RequestHeader(value="token",required=false) String token,@PathVariable String id,@Valid @RequestBody QlSettlementBo bo){Map<String,Object>a=staff.access(token);staff.permit(a,"can_payment");registrations.confirmSettlement(id,bo,staff.operator(a));return AjaxResult.success();}
